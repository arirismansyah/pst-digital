$(document).ready(function () {
    $('#add-konsultasi-btn').on('click', function () {
        $('#modal-add-konsultasi').modal('show');
    })

    $("#check-pernah-daftar").change(function() {
        if(this.checked) {
            $("#label-check-pernah-daftar").html('Sudah pernah');
            $('#form-new-customer').hide();
            $('#form-recent-customer').show();
        } else {
            $("#label-check-pernah-daftar").html('Belum pernah');
            $('#form-new-customer').show();
            $('#form-recent-customer').hide();
        }
    });
